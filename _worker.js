...
const PROXY_BANK_URL = "https://raw.githubusercontent.com/Novantunn/crot/main/output.txt";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Bezzo <span class='text-blue-500 font-semibold'>Perantau</span>");
